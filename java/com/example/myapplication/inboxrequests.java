...
public class inboxrequests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inboxrequests);
    ...
    private void fetchuserinboxdonations() {
        ...
        String url = "http://10.0.2.2/communi/inboxrequestsdatadisplay.php"; // Replace with your PHP script's URL
                    ...
                    if (jsonResponse.getBoolean("status")) {
                        ...
                        if (jsonArray.length() > 0) {
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                View detailView = getLayoutInflater().inflate(R.layout.inbox_request_page, null);
                                ...
                                detaildesTextView.setText("Request: " + des);

                                if(actions.equals("Needed")) {
                                    //update the text in the button
                                    updateButton.setText("Needed");
                                ...
                                else
                                {
                                    ...
                                    updateButton.setBackgroundColor(Color.rgb(3,2,1));
                                }
    ...
    private void updateData(String room, String selectedStatus,String timedate,String idofuser,String mbofuser) {
        ...
        String updateUrl = "http://10.0.2.2/communi/inboxrequestupdate.php"; // Replace with your PHP script's update URL
