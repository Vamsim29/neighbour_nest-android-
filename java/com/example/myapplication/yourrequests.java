...
public class yourrequests extends AppCompatActivity {
    ...
    public void gotomakeadonationpage(){
        Intent intent=new Intent(this,makearequest.class);
        Intent intent1 = getIntent();
        String userIdp = intent1.getStringExtra("idus");
        intent.putExtra("idus", userIdp);
        startActivity(intent);
    ...
    private void fetchUserYourDonations() {
        ...
        String userIdp = intent1.getStringExtra("idus");
        //String userIdp = "t24f";
        String url = "http://10.0.2.2/communi/yourrequestsdatadisplay.php"; // Replace with your PHP script's URL
                        ...
                        if (jsonArray.length() > 0) {
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getApplicationContext(),
                                        R.array.status_array_three, android.R.layout.simple_spinner_item);
    ...
    private void updateData(String room,String DateTime ,String selectedStatus) {
        ...
        String updateUrl = "http://10.0.2.2/communi/dnm.php"; // Replace with your PHP script's update URL
