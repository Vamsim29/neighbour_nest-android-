...
public class makearequest extends AppCompatActivity {
    ...
    private String URL = "http://10.0.2.2/communi/makerequest.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_makearequest);
                        ...
                        if (response.has("status")) {
                            ...
                            if (status.equals("success")) {
                                ...
                                try {
                                    ...
                                    Toast.makeText(makearequest.this, message, Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(makearequest.this, yourrequests.class);
